...
#     #         # 'LOG_FILE': log_file,
#     #         'LOG_LEVEL': 'INFO',
#     #         # 'FEEDS': {f"s3://{os.getenv('OUTPUT_BUCKET')}/output/daily_collections/jll/{current_date}/{name}.json": {"format": "json"}},
#     #     }
...
#             url="https://www.ten-x.com/search/cu/api/86a5qs/api/v1/listing/search?page=0&size=100"
#             payload = {
#             "rl": 500,
#             "sort": 0,
#             "criteria": {
